...
# Use SQLite by default, MySQL if DATABASE_URL is provided
...
if DATABASE_URL:
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': os.getenv('DATABASE_NAME', 'bloodfy_db'),
...
# CORS Configuration
CORS_ALLOW_ALL_ORIGINS = True # Set to True for development to avoid origin mismatches
